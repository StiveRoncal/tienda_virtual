<?php
    ...
    // Header de una funcion de helper
    headertienda($data);
	getModal('modalCarrito', $data);

	// Almacena arreglo de Controlers/Home.php
			...
			?>
				<div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
					...
					<div class="block1 wrap-pic-w">
						<img src="<?= $arrBanner[$s]['portada']; ?>" alt="<?= $arrBanner[$s]['nombre'];?>">

						<a href="<?= base_url().'/tienda/categoria/'.$arrBanner[$s]['nombre'];?>" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<?php
				...
				// recorre todos los valores de arreglos
				for($p=0; $p < count($arrProductos) ; $p++){

					// validar si existe foto en la columna images 
					if(count($arrProductos[$p]['images']) > 0){	

						// almcea la primer registro de img 
						$portada = $arrProductos[$p]['images'][0]['url_image'];

					}else{
						// de lo contrario da foto por defecto
