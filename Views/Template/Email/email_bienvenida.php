<!-- HTML del EMAIL de LINK de resetar correo  -->
<!DOCTYPE html>
<html lang="es">
<head>
	<meta charset="UTF-8">
		...
		<tbody>
			...
			<tr>
				<td>
                    ...
                    <P>Bienvenido a nuestra Tienda en Línea. Estimado Senatino</P>
                    <p>Ahora Puedes realizar tus Compras en línea sin Salir de tu Casa.</p>
                    <p>Accede a tu Cuenta con tus Credenciales</p>
                    <p>Usuario: <strong><?= $data['email']?></strong></p>
                    <p>Constraseña: <strong><?= $data['password']?></strong></p>
