		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-lg-4 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Av. España Nro. 845 San Martin de Pangoa <br>
						Cel: (+51) 934 027 842
					</p>

					<div class="p-t-27">
						<a href="https://www.facebook.com/FacturacionelectronicaGrosotec" target="_blank" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					<?= NOMBRE_EMPRESA;?> | <?= NOMBRE_EMPRESA;?> <a href="https://colorlib.com" target="_blank">Colorlib</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
